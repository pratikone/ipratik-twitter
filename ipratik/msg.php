...
switch ($state) {/*{{{*/
  ...
  case 'returned':
    ...
    $content1=$to->OAuthRequest('http://twitter.com/statuses/user_timeline/'.$_SESSION['username'].'.xml?count=1',array(),'GET');
...
echo "<br>Refresh once after clearing session<br>";
