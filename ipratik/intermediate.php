...
switch ($state) {/*{{{*/
  ...
  case 'returned':
    ...
    //$content1=$to->OAuthRequest('http://twitter.com/statuses/user_timeline/pratikone.xml?count=1',array(),'GET');
    break;
    
}/*}}}*/
//SESSION for username and update msg
...
echo "<br>Refresh once after clearing session";
